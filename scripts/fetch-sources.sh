...
download "$PAM_URL" "$DOWNLOAD_DIR/$PAM_TARBALL"
download "$NIX_URL" "$DOWNLOAD_DIR/$NIX_TARBALL"
...
extract_tarball_into "$DOWNLOAD_DIR/$PAM_TARBALL" "$PAM_SRC_DIR"
extract_tarball_into "$DOWNLOAD_DIR/$NIX_TARBALL" "$NIX_SRC_DIR"
